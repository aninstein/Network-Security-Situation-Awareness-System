...
// 	  		All_Sum=All_Sum+all_sum[i];
	  	...
	  	Risk=((double)Risk_sum/(49.5*0.07781))*100;//化成百分比,49.5是5.5*9*1,之所以*1是因为w的和为1
	  	Risk=Double.parseDouble(df.format(Risk));//字符串化double；
...
<body>
<!-- 一天的折线图的Dom -->
<div id="echarts_meter2" style="width:450px; height:300px;"></div><!-- margin-top:40px; float:left;-->
<script type="text/javascript">

var Risk_num=<%=Risk%>;//资产指资产
var myChart = echarts.init(document.getElementById('echarts_meter2'));
var option= {
    title: {
        text: '当前脆弱指数\n',
        left:'center'
