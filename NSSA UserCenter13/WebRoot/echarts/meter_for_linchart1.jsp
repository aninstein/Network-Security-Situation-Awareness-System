...
// 	  		All_Sum=All_Sum+all_sum[i];
	  	...
	  	Assets=((double)Assets_sum/(49.5*0.40830))*100;//化成百分比,49.5是5.5*9*1,之所以*1是因为w的和为1
	  	Assets=Double.parseDouble(df.format(Assets));//字符串化double；
...
<body>
<!-- 一天的折线图的Dom -->
<div id="echarts_meter1" style="width:450px; height:300px;"></div><!-- margin-top:40px; float:left;-->
<script type="text/javascript">

var myChart = echarts.init(document.getElementById('echarts_meter1'));
var Assets_num=<%=Assets%>;//资产指数
var option1 = {
    title: {
        text: '当前威胁指数\n',
        left:'center'
