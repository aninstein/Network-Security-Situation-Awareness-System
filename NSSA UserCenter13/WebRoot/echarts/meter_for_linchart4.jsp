...
// 	  		All_Sum=All_Sum+all_sum[i];
	  	...
	  	Positive=((double)Positive_sum/(49.5*0.17448))*100;//化成百分比,49.5是5.5*9*1,之所以*1是因为w的和为1
	  	Positive=Double.parseDouble(df.format(Positive));//字符串化double；
...
<body>
<!-- 一天的折线图的Dom -->
<div id="echarts_meter4" style="width:450px; height:300px;"></div><!-- margin-top:40px; float:left;-->
<script type="text/javascript">

var Positive_num=<%=Positive%>;//资产指数
var myChart = echarts.init(document.getElementById('echarts_meter4'));
var option = {
    title: {
        text: '当前容灾指数\n',
        left:'center'
    ...
    series: [
        {
            ...
            data: [{value: Positive_num, name: '数值'}]
        }
    ]
};
